...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Detail Service' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('detail_services.detail_services.update', $detailServices->id) }}"
                id="edit_detail_services_form" name="edit_detail_services_form" accept-charset="UTF-8"
